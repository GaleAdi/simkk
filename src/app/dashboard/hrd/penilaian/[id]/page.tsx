    ...
    <div className="space-y-6 max-w-3xl">
      <div>
        ...
        <p className="text-gray-500 mt-1">
          Penilaian untuk <span className="font-medium text-gray-700">{assessment.target.nama}</span>
          {" "}oleh <span className="font-medium text-gray-700">{assessment.penilai.username}</span>
        </p>
      </div>
      ...
      <AKHLAKFormClient
        ...
        backUrl="/dashboard/hrd/penilaian"
      />
    </div>
  );
}
